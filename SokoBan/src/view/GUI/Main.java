...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			RecordsTableWindowController recordsTableWindowController = (RecordsTableWindowController) recordsTableWindowloader
					.getController();
			...
			// Main Window
			Scene mainWindowScene = new Scene(mainWindowroot); // Scene scene =
																// new
																// Scene(root,900,800);
			...
			Scene recordsTableWindowScene = new Scene(recordsTableWindowroot); // Scene
																				// scene
																				// =
																				// new
																				// Scene(root,900,800);
